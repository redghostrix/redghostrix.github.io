...
This uses a Node.js theme ([jsonresume-theme-caffine](https://github.com/redghostrix/jsonresume-theme-caffine)) via subprocess—a pragmatic choice that leverages the best tools regardless of language boundaries.
...
The complete source code is available on [**GitHub**](https://github.com/redghostrix/ai-powered-job-search)
